...
export default function AfterSchoolHero() {
  return (
        ...
        <div className="text-left text-white">
          <h1 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-400">
              and Apartment Classes
            </span>
          </h1>
          <p className="text-xl lg:text-2xl mb-8 max-w-3xl leading-relaxed text-gray-200">
            Bringing Fitness and Fun to Your Doorstep. Thoughtfully designed physical activities that develop motor skills, improve social interaction, and build strength—all while having fun with peers.
          </p>
