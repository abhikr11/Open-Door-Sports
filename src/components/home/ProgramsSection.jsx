...
export default function ProgramsSection() {
  const programs = [
    ...
    },
    {
      ...
      description: "At this stage, our focus is on fostering the overall physical development of the child. The program is designed to enhance physical fitness, while also identifying and nurturing individual talents and motor skills.",
    ...
    },
    {
      ...
      description: "At this stage, children are introduced to specific sports and co-curricular activities that challenge and refine their growing abilities. The focus is on applying their developing skills in more structured and competitive settings.",
