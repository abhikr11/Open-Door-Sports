      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <div className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-8 cursor-pointer bg-white">
              ...
              <button 
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-4 rounded-lg font-bold text-lg hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer"
              >
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
            ...
            <p className="text-blue-100 text-sm mt-1">Mon-Fri: 8AM-6PM</p>
          </div>

          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
            <i className="ri-mail-line w-8 h-8 flex items-center justify-center text-white text-3xl mx-auto mb-4"></i>
            <h3 className="text-xl font-bold text-white mb-2">Email Us</h3>
            <p className="text-blue-100">events@opendoorsports.com</p>
            <p className="text-blue-100 text-sm mt-1">Response within 24 hours</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
            ...
            <p className="text-blue-100">2 months minimum</p>
            <p className="text-blue-100 text-sm mt-1">For best results</p>
          </div>
        </div>
      </div>
    </section>
